# rm(list=ls())
## Please read these comments before running the Rcode contained in this R script!
##
## In order for the Rcode to execute, users need to set the object: dir_supplemental (line 133)
## to be the parent directory of the "Rcode" folder contained in the supplemental material.
## For additional details regarding the analyses performed here, please refer to the manuscript.
##
## The Rcode below is divided into the following "chunks"
...
##                  accelerometry features calculated in Section 2 of this Rcode.
##
...
##
##  Finally, although most of the Rcode executes fairly quickly, there are two sections that may take a few minutes to run.
...
##  The other chunk that takes time to run is the forward selection procedure. There's a print statement embedded in the Rcode that will
...
code_path        <- file.path(dir_supplemental, "supplemental_material", "code")     ## file path where helper functions and Rcode to create figures are located
...
## re-Rcode activity counts which are considered "non-wear" to be 0
